...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/githubliangliang/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="githubliangliang/sub2api"
