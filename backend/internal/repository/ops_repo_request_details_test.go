...
func TestOpsRepositoryListRequestDetails_LatencySort(t *testing.T) {
	for _, tc := range []struct {
		...
		{name: "TTFT", sort: "ttft_desc", order: "first_token_ms IS NULL, first_token_ms DESC, created_at DESC"},
		{name: "duration", sort: "duration_desc", order: "duration_ms IS NULL, duration_ms DESC, created_at DESC"},
